...
# Docker (root:root 600) vers un tmpfs prive lisible par appuser, puis droppe
# les privileges avant d'exec l'appli. Necessaire car ce moteur Docker Compose
...
for f in /run/secrets/*; do
  ...
  chown appuser:appuser "/tmp/secrets/$name"
done
